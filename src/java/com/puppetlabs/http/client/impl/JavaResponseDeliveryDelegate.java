...
public final class JavaResponseDeliveryDelegate implements ResponseDeliveryDelegate {
    ...
    @Override
    public void deliverResponse(RequestOptions requestOptions, String origContentEncoding, Object body, Map<String, String> headers, int statusCode, ContentType contentType, IResponseCallback callback) {
        deliverResponse(new Response(requestOptions,
                        origContentEncoding,
                        body,
                        headers,
                        statusCode,
